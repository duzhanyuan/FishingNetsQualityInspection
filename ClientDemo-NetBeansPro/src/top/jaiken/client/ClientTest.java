...
import top.jaiken.main.LineBreakChecking;
...
public class ClientTest extends javax.swing.JFrame {
	...
	ImageCut cut;
	MissPointChecking missPointChecking;
	LineBreakChecking lineBreakChecking;
	boolean isChecking;
	Timer timer;
	TimerTask task;
	...
	private void initComponents() {
		...
		cut = new ImageCut();
		missPointChecking = new MissPointChecking();
		...
		jMenuAdjust = new javax.swing.JMenu();
		jMenuItemAdjustCom = new javax.swing.JMenuItem();
		jMenuItemAdjustLight = new javax.swing.JMenuItem();
		...
		task = new TimerTask() {
			...
			public void run() {
				...
				Mat src = cut.getDVRPic(cameraInfo);
				Mat circles = missPointChecking.getPoints(src);
				boolean flag = lineBreakChecking.isLineBreak(src);
		...
		jPasswordFieldPassword.setText("wh123456");
		...
		jPanelUserInfoLayout.setVerticalGroup(jPanelUserInfoLayout
				...
				.addGroup(jPanelUserInfoLayout.createSequentialGroup().addGap(18, 18, 18)
						...
						.addComponent(jComboBoxCallback, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(10, 10, 10).addComponent(jButtonExit).addGap(10, 10, 10).addComponent(jButtonStart)
						.addContainerGap()));
		...
		jMenuAdjust.setText("校准");
		
		jMenuItemAdjustLight.setText("光线校准");
		jMenuItemAdjustLight.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mousePressed(java.awt.event.MouseEvent evt) {
				jMenuItemAdjustLightMousePressed(evt);
			}

		});
		
		jMenuItemAdjustCom.setText("相机校准");
		jMenuItemAdjustCom.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mousePressed(java.awt.event.MouseEvent evt) {
				jMenuItemAdjustComMousePressed(evt);
			}
		});
		jMenuAdjust.add(jMenuItemAdjustCom);
		jMenuAdjust.add(jMenuItemAdjustLight);
		jMenuBarConfig.add(jMenuAdjust);
	...
	private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonLoginActionPerformed
		...
		if (userID == -1) {
			...
			JOptionPane.showMessageDialog(ClientTest.this, "注册失败");
		} else {
			cameraInfo.setCameraIP(m_sDeviceIP);
			cameraInfo.setCameraPort(iPort);
			cameraInfo.setCameraUserName(jTextFieldUserName.getText());
			cameraInfo.setCameraPassWord(new String(jPasswordFieldPassword.getPassword()));
	...
	/*************************************************
	 * 函数: " 校准" 按钮响应函数 函数描述: 校准摄像机位置和霍夫检测参数
	 *************************************************/
	...
	/*************************************************
	 * 函数: "相机校准" 按文件 菜单项响应函数 函数描述:打开霍夫调试参数
	 *************************************************/
	private void jMenuItemAdjustComMousePressed(java.awt.event.MouseEvent evt)// GEN-FIRST:event_jMenuItemVoiceComMousePressed
	{// GEN-HEADEREND:event_jMenuItemVoiceComMousePressed
		...
		JDialogAdjust adjust = new JDialogAdjust(this, false, lUserID, m_strDeviceInfo);
	...
	private void jMenuItemAdjustLightMousePressed(MouseEvent evt) {
		// TODO Auto-generated method stub
		...
		JDialogAdjustLight adjust = new JDialogAdjustLight(this, false, lUserID, m_strDeviceInfo);
	...
	int getChannelNumber() {
		...
		if (tp != null)// 判断路径是否有y效,即判断是否有通道被选中
		{
			// 获取选中的通道名,对通道名进行分析:
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				ClientTest Demo = new ClientTest();
				centerWindow(Demo);
	...
	private javax.swing.JMenuItem jMenuItemAdjustCom;
	private javax.swing.JMenuItem jMenuItemAdjustLight;
	private javax.swing.JMenu jMenuManage;
	private javax.swing.JMenu jMenuPlayBack;
	private javax.swing.JMenu jMenuSetAlarm;
	private javax.swing.JMenu jMenuAdjust;
