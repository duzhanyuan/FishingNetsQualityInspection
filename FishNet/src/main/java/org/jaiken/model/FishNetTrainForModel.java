...
/**
 * @TODO 基于AlexNet 和LeNet 分别对比进行训练，数据集在FishNetTrain 文件夹中
 * @author JaikenWong
 */

@SuppressWarnings("deprecation")
public class FishNetTrainForModel {
	...
	public void run(String[] args) throws Exception {
		...
		File mainPath = new File("FishNetTrain");
		...
		log.info("Build org.jaiken.model....");
...
//        MultiLayerNetwork network = new AlexNet(height, width, channels, numLabels, seed, iterations).init();
		...
		case "custom":
			...
			break;
		default:
			throw new InvalidInputTypeException("Incorrect org.jaiken.model provided.");
		}
		network.init();
		 ...
		 * save memory - trainIter = uses MultipleEpochsIterator to ensure org.jaiken.model runs
		 * through the data for all epochs
		 **/
		ImageRecordReader recordReader = new ImageRecordReader(height, width, channels, labelMaker);
		DataSetIterator dataIter;

		log.info("Train org.jaiken.model....");
		...
		log.info("Evaluate org.jaiken.model....");
		...
		// Example on how to get predict results with trained org.jaiken.model. Result for first
		...
		System.out.print("\nFor a single example that is labeled " + expectedResult + " the org.jaiken.model predicted "
				+ modelPrediction + "\n\n");

		if (save) {
			log.info("Save org.jaiken.model....");
	...
	public MultiLayerNetwork alexnetModel() {
		/**
		 * AlexNet org.jaiken.model interpretation based on the original paper ImageNet
	...
	public static MultiLayerNetwork customModel() {
		/**
		 * Use this method to build your own custom org.jaiken.model.
		 **/
		return null;
	}

	public static void main(String[] args) throws Exception {
		new FishNetTrainForModel().run(args);
	}
