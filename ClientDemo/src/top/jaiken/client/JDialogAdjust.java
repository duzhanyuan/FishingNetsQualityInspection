 ...
 *类描述 ：语音对讲
 ****************************************************************************/
public class JDialogAdjust extends javax.swing.JDialog {
     ...
     *************************************************/
    public JDialogAdjust(java.awt.Frame parent, boolean modal, NativeLong lUserID, HCNetSDK.NET_DVR_DEVICEINFO_V30 strDeviceInfo) 
    {
        super(parent, modal);
        try
        {
        ...
        {
            Logger.getLogger(JDialogAdjust.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
	...
	if ( ClientTest.g_lVoiceHandle.intValue() == -1)
	{
	...
	{
		if (hCNetSDK.NET_DVR_StopVoiceCom( ClientTest.g_lVoiceHandle))
		{
			 ClientTest.g_lVoiceHandle.setValue(-1);
		}
		else
		{
