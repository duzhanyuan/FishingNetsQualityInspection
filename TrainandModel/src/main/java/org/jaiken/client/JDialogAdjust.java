...
public class JDialogAdjust extends JFrame {
	...
	public void init() {
		...
		slider1.setValue((int)(HoughCheck.DP*10));
		...
		slider2.setValue((int)HoughCheck.MINDIST);
		...
		slider3.setValue((int)HoughCheck.PARAM1);
		...
		slider4.setValue((int)HoughCheck.PARAM2);
		...
		slider5.setValue(HoughCheck.MINRADIUS);
		...
		slider6.setValue(HoughCheck.MAXRADIUS);
		...
		jButtonTest.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				List<Mat> mat = imageCut.getDVRPic(cameraInfo);
				HoughCheck missPointChecking = new HoughCheck();
				//ThresholdValueAnalysis thresholdValueAnalysis=new ThresholdValueAnalysis();
				//setValue();
				Mat circles=missPointChecking.getPoints(mat.get(0));
				//thresholdValueAnalysis.getThresholdValueImg(mat);
				@SuppressWarnings("unused")
				JFrameShowCheckResult jFrameShowCheckResult = new JFrameShowCheckResult(circles.cols());
	...
	private void setValue() {
		...
		HoughCheck.DP = value1;
		HoughCheck.MINDIST = value2;
		HoughCheck.PARAM1 = value3;
		HoughCheck.PARAM2 = value4;
		HoughCheck.MINRADIUS = value5;
		HoughCheck.MAXRADIUS = value6;
	}
